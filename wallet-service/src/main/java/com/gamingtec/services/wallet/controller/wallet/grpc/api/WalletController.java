package com.gamingtec.services.wallet.controller.wallet.grpc.api;

import com.gamingtec.services.wallet.controller.wallet.grpc.internal.mapper.WalletGrpcMapper;
...
public class WalletController extends WalletApiGrpc.WalletApiImplBase {
  ...
  public void balanceRequest(WalletMessages.BalanceRequestGrpc grpcReq,
    ...
    try {
      BalanceRequest req = walletGrpcMapper.mapToBalanceReq(grpcReq);
      walletManageService.getBalance(req);
